...
Es gibt [Erweiterungen auf der offiziellen Webseite](https://datenstrom.se/de/yellow/extensions/), diese werden von Entwicklern gepflegt und immer auf dem neusten Stand gehalten. Es gibt auch experimentelle Erweiterungen auf [Codeberg](https://codeberg.org/explore/repos?q=datenstrom-yellow&topic=true&sort=moststars), [GitHub](https://github.com/topics/datenstrom-yellow) und anderen Git-Hosting-Platformen. Du kannst selbst entscheiden, ob du experimentelle Erweiterungen auf deiner Webseite benutzen möchtest oder nicht. Denke daran dass nur Erweiterungen die auf der offiziellen Webseite verfügbar sind in den Aktualisierungsmechanismus einbezogen werden.
